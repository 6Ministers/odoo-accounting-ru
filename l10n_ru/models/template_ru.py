...
class AccountChartTemplate(models.AbstractModel):
    ...
    def _get_ru_template_data(self):
        return {
            ...
            "property_stock_account_input_categ_id": "ru_acc_41_01",
            "property_stock_account_output_categ_id": "ru_acc_45_01",
    ...
    def _get_ru_res_company(self):
        return {
            self.env.company.id: {
                ...
                # "account_default_pos_receivable_account_id": "ru_acc_50_01",
                ...
                "default_cash_difference_expense_account_id": "ru_acc_94",
